...
export default function NotificationsPage() {
    ...
    return (
        <div className="space-y-6 pb-24 max-w-4xl mx-auto p-4 md:p-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-muted-foreground font-medium text-sm">Stay updated with system activities.</p>
                </div>
                                        ...
                                        {n.entityId && (
                                            <div className="pt-2">
                                                <Button variant="secondary" size="sm" className="h-8 bg-white border border-slate-200 text-indigo-600 font-black text-[10px] tracking-widest px-4 hover:bg-slate-50 rounded-full" asChild>
                                                    <Link href={
                                                        n.entityType === 'JOB' ? `/admin/jobs/${n.entityId}` :
                                                            n.entityType === 'TICKET' ? `/admin/requests` : // No direct ticket link yet?
                                                                n.entityType === 'PAYOUT' ? `/admin/finance` :
                                                                    '#'
                                                    }>
