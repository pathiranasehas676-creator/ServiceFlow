...
export class AdminVerificationController {
  ...
  @Get('id/:id')
  async getIdDetails(@Param('id') id: string) {
    return this.verificationService.getIdVerificationDetails(id);
  }
  ...
  async rejectId(
    ...
    return this.verificationService.rejectIdVerification(
      id,
      admin.id,
      body.reason,
    );
  ...
  async rejectBank(
    ...
    return this.verificationService.rejectBankVerification(
      id,
      admin.id,
      body.reason,
    );
