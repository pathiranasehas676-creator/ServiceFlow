...
export class RequestsController {
  ...
  async approveVerification(
    ...
    return this.requestsService.approveVerification(
      verificationId,
      req.user.userId,
      dto,
    );
  ...
  async rejectVerification(
    ...
    return this.requestsService.rejectVerification(
      verificationId,
      req.user.userId,
      dto,
    );
  ...
  async approveBank(
    ...
    return this.requestsService.approveBankVerification(
      id,
      req.user.userId,
      dto,
    );
  ...
  async rejectBank(
    ...
    return this.requestsService.rejectBankVerification(
      id,
      req.user.userId,
      dto,
    );
  ...
  async closeTicket(@Param('id') ticketId: string, @Req() req: any) {
  ...
  @ApiOperation({ summary: 'Get all job disputes' })
  @ApiQuery({ name: 'page', required: false, type: Number })
  @ApiQuery({ name: 'limit', required: false, type: Number })
  @ApiQuery({ name: 'status', required: false, type: String })
  @ApiQuery({ name: 'q', required: false, type: String })
  async getDisputes(@Query() dto: PaginationDto) {
    return this.requestsService.getDisputes(dto);
  }
  ...
  async getDispute(@Param('id') id: string) {
    return this.requestsService.getDisputeDetail(id);
  }

  @Post('disputes/:id/mark-in-review')
  @Permissions('MANAGE_JOB_PAYMENTS')
  @ApiOperation({ summary: 'Mark dispute as being in review' })
  async markDisputeInReview(@Param('id') id: string, @Req() req: any) {
    return this.requestsService.markDisputeInReview(id, req.user.userId);
  }

  @Post('disputes/:id/resolve')
  @Permissions('MANAGE_JOB_PAYMENTS')
  @ApiOperation({ summary: 'Resolve a job dispute' })
  async resolveDispute(
    @Param('id') id: string,
    @Body() dto: ResolveDisputeDto,
    @Req() req: any,
  ) {
    return this.requestsService.resolveDispute(id, req.user.userId, dto);
  }
  ...
  @ApiQuery({ name: 'status', required: false, type: String })
  @ApiQuery({ name: 'q', required: false, type: String })
  async getRegistrationRequests(@Query() dto: PaginationDto) {
    return this.requestsService.getRegistrationRequests(dto);
  }

  @Post('registrations/:id/approve')
  @Permissions('PROCESS_REQUESTS')
  @ApiOperation({ summary: 'Approve registration request' })
  async approveRegistration(
    @Param('id') id: string,
    @Body() dto: ApproveRequestDto,
    @Req() req: any,
  ) {
    return this.requestsService.approveRegistration(
      id,
      req.user.userId,
      req.user.email,
      dto,
  ...
  async rejectRegistration(
    ...
    return this.requestsService.rejectRegistration(
      id,
      req.user.userId,
      req.user.email,
      dto,
  ...
  @Post('registrations/:id/invite')
  @Permissions('PROCESS_REQUESTS')
  @ApiOperation({ summary: 'Send invite to approved request' })
  async inviteRegistration(
    @Param('id') id: string,
    @Body() dto: InviteRequestDto,
    @Req() req: any,
  ) {
    return this.requestsService.inviteRegistration(
      id,
      req.user.userId,
      req.user.email,
      dto,
  ...
  @Post('registrations')
  @Permissions('PROCESS_REQUESTS')
  @ApiOperation({ summary: 'Manually create registration request' })
  async createRegistrationRequest(
    @Body() dto: RequestAccessDto,
    @Req() req: any,
  ) {
    return this.requestsService.createRegistrationRequest(
      dto,
      req.user.userId,
      req.user.email,
      req.ip,
